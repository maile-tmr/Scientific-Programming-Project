...
library(remotes)
#Install Seurat 5 from GitHub
remotes::install_github("satijalab/seurat", "seurat5", quiet = TRUE)
#Install library(SeuratData) from GitHub
remotes::install_github("satijalab/seurat-data", "seurat5", quiet = TRUE)

#Besided GitHub, we can install Seurat from CRAN
...
###--------------------------------------------------------------------------###
##Part 4: Batch-corrected clustering and visualization of scRNA-seq data
...
data <- RunUMAP(data, reduction = "harmony", dims = 1:50, n.neighbors =440)
...
###--------------------------------------------------------------------------###
##Part 5: Find marker genes for each cluster
...
###--------------------------------------------------------------------------###
##Part 6: Annotate cell types for each cluster
