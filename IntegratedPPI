...
###--------------------------------------------------------------------------###
##Part 3: Combine the co-expression and PPI networks
#In this section, we subset the PPI to match the same genes as the co-expression
#network. We also subset the co-expression network (TOM) to match the PPI.
...
###--------------------------------------------------------------------------###
##Part 4: Identifying hub genes in the integrated network
...
###--------------------------------------------------------------------------###
##Part5: Visualizing the integrated network
...
#Repeat steps 3 (from # Select the module to plot), 4, and 5 for modules 13, 18
